...
This directory generates synthetic TIMA training candidates with Qwen3.5 through DigitalOcean Serverless Inference. The generator validates each response, balances action labels, supports resumable runs, and packages approved rows as deterministic Hugging Face dataset splits.
